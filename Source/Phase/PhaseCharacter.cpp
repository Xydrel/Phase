...
void APhaseCharacter::SetupPlayerInputComponent(class UInputComponent* InputComponent)
{
	...
	InputComponent->BindAxis("TurnRate", this, &APhaseCharacter::TurnAtRate);
...
void APhaseCharacter::TouchStarted(ETouchIndex::Type FingerIndex, FVector Location)
{
...
void APhaseCharacter::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
...
void APhaseCharacter::MoveRight(float Value)
{
	if ( (Controller != NULL) && (Value != 0.0f) )
	{
